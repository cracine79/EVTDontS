...
def seed_chapters(units):
    ...
    chapter1_1 = Chapter(name="1.1 Scarcity, Choice and Opportunity Cost", unit = units[0], video_url="https://youtu.be/mfGKKxwC_fE")
    chapter1_2 = Chapter(name="1.2 Factors of Production", unit = units[0], video_url="https://youtu.be/WqlGzTYXd0U")
    chapter1_3 = Chapter(name="1.3 Economic Systems", unit = units[0], video_url="https://youtu.be/X0ak8ID7zY8")
    chapter1_4a = Chapter(name="1.4a The Production Possibilities Curve", unit = units[0], video_url="https://youtu.be/HeUTq7VwZaI")
    chapter1_4b = Chapter(name="1.4b Opportunity Cost and the PPF", unit = units[0], video_url="https://youtu.be/6CQvC5rugh4")
    chapter1_5 = Chapter(name="1.5 Absolute and Comparative Advantage", unit = units[0], video_url="https://youtu.be/Z7dXOetE3CQ")
    chapter1_5a = Chapter(name="1.5a Answering AP and University Level Comparative Advantage Questions", unit=units[0], video_url="https://youtu.be/euARcQwvT5Y")
    chapter2_1 = Chapter(name="2.1 Demand Introduced", unit = units[1], video_url="https://youtu.be/xiS1DiQbo74")
    chapter2_1a = Chapter(name="2.1a Non-Price Determinants of Demand", unit = units[1], video_url="https://youtu.be/t9vqT36mg2E")
    chapter2_2 = Chapter(name="2.2 Supply Introduced", unit = units[1], video_url="https://youtu.be/AUPcL91u008")
    chapter2_2a = Chapter(name="2.2a Non-Price Determinants of Supply", unit = units[1], video_url="https://youtu.be/QByejdJI58o")
    chapter2_3 = Chapter(name="2.3 Supply and Demand in Equilibrium", unit = units[1], video_url="https://youtu.be/V10jYy7maS4")
    chapter2_4 = Chapter(name="2.4 Shifts to Supply and Demand", unit = units[1], video_url="https://youtu.be/Cf0J-2dY7Dg")
    chapter2_5 = Chapter(name="2.5 Simultaneous Shifts to Supply and Demand", unit = units[1], video_url="https://youtu.be/ZtEp5B-xeMI")
    chapter2_6a = Chapter(name="2.6a Marginal Utility, Marginal Benefit, and Demand", unit = units[1], video_url="https://youtu.be/9UzdtdrjURY")
    chapter2_6b = Chapter(name="2.6b Marginal Cost and Supply", unit = units[1], video_url="https://youtu.be/QByejdJI58o")
    chapter2_7 = Chapter(name="2.7 Consumer Surplus, Producer Surplus, and Social Surplus", unit = units[1], video_url="https://youtu.be/HNhtJYbagF0")
    chapter2_8 = Chapter(name="2.8 Allocative Efficiency", unit = units[1], video_url="https://youtu.be/kPwEpVKTD0A")
    chapter3_1 = Chapter(name="3.1 Price Elasticity of Demand (PED)", unit = units[2], video_url="https://youtu.be/bYUkZeZfZO8")
    chapter3_2 = Chapter(name="3.2 Determinants of Price Elasticity of Demand", unit = units[2], video_url="https://youtu.be/40ZX1_6ebEY")
    chapter3_3 = Chapter(name="3.3 PED and Total Revenue", unit = units[2], video_url="https://youtu.be/A7MHjOWFTv0")
    chapter3_4 = Chapter(name="3.4 Cross Price Elasticity of Demand (XED)", unit = units[2], video_url="https://youtu.be/O-gLeuGNgAs")
    chapter3_5 = Chapter(name="3.5 Income Elasticity of Demand", unit = units[2], video_url="https://youtu.be/lZVZYc1yVbY")
    chapter3_6 = Chapter(name="3.6 Price Elasticity of Supply", unit = units[2], video_url="https://youtu.be/4Jpvus1kpr8")
